<template>
  <div>
   ...
   <template>
    ...
    <v-navigation-drawer  src="https://eurofique.info/wp-content/gallery/visita-virtual-expo-fique-historia-y-futuro/07-saco-de-fique.jpg"  v-model="drawer" absolute temporary v-if="$store.state.token != ''">
      <v-img
...
traerUsuario() {
      this.persona = this.$store.state.usuarios
